...
> Defesa do TCC: **19/05/2026**

- [ ] **20/05** — Pausar/deletar serviço Railway pra evitar cobrança continuada (~US$5/mês)
- [ ] Workflow `.github/workflows/lembrete-pos-tcc.yml` abre issue automática no dia 19/05 com o checklist de desligamento
